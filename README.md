...
[![](https://github.com/step-security/upload-dsyms-github-action/workflows/build-test/badge.svg)](https://github.com/step-security/upload-dsyms-github-action/actions)
  ...
  build:
    ...
    steps:
      ...
      - name: Upload dSYMs to Datadog
        uses: step-security/upload-dsyms-github-action@v0
        with:
